class  Admin::MakesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @make.save
        format.html { redirect_to admin_makes_path, notice: 'Make was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @make.update(make_params)
        format.html { redirect_to admin_makes_path, notice: 'Make was successfully updated.' }
  ...
  def destroy
    @make.destroy
    respond_to do |format|
      format.html { redirect_to admin_makes_url, notice: 'Make was successfully deleted.' }
