class  Admin::ModelsController < Admin::BaseController
  ...
  before_action :get_makes, only: [:new, :edit]
  ...
  def update
    respond_to do |format|
      if @model.update(model_params)
        format.html { redirect_to admin_models_path, notice: 'Model was successfully updated.' }
  ...
  def destroy
    @model.destroy
    respond_to do |format|
      format.html { redirect_to admin_models_path, notice: 'Model was successfully deleted.' }
